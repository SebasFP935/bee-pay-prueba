# 🏟️ BeePay — Gestión de Reservas Deportivas
...
|------|-----------|----------|
| Frontend | React 18 + Vite | Rápido de configurar, HMR, soporte moderno |
| Backend | Spring Boot 3.2 + Java 21 | Estructura robusta, validaciones con anotaciones, manejo de errores centralizado |
| Base de datos | PostgreSQL | Relacional, soporte nativo en Spring Data JPA |
| ORM | Hibernate / JPA | Evita SQL manual, mapeo automático de entidades |
| Estilos | CSS puro con variables | Sin dependencia extra, diseño consistente con tokens |
...
Si desea puede insertar en postgresql este linea de código completa
